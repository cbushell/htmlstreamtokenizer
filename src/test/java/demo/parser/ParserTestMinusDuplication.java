...
public class ParserTestMinusDuplication {
	...
	public void test3() {
		...
		String html = "<P><B>Please contact Public Affairs Division for the text of the paper	"
	...
	@Test
	public void test2() {
		String html = "<INPUT TYPE=HIDDEN NAME=\"MfcISAPICommand\" VALUE = \"MailBox\">\n"
		...
		String expected = "<INPUT TYPE=\"HIDDEN\" NAME=\"MfcISAPICommand\" VALUE=\"MailBox\">\n"
	...
	@Test
	public void test1() {
		String html = "<p><UL><LI>    left	terms and list operators (leftward)</LI>\n"
				+ "<LI>    left	-></LI>\n"
				+ "<LI>    nonassoc	++ --</LI>\n"
				+ "<LI>    right	**</LI>\n"
		...
		String expected = "<p><UL><LI>    left\tterms and list operators (leftward)</LI>\n"
				+ "<LI>    left\t-></LI>\n"
				+ "<LI>    nonassoc\t++ --</LI>\n"
				+ "<LI>    right\t**</LI>\n"
				+ "<LI>    right\t! ~ \\ and unary + and -</LI>\n"
